...
<script>
  ...
  "Hvis du kunne velge et instrument du automatisk hadde mestret, hvilket hadde det vært?",
  ...
  "Hva er det rareste objektet du eier?",
  "Hva er den mest absurde saken du har sett på nyhetene?",
  "Hva er den mest interessante teorien du har hørt om?",
  "Hvis du kunne velge en ferdighet fra et dyr som du kunne hatt selv, hva hadde det vært?",
  "Hvis du kunne reise tilbake i tid og være vitne til et historisk øyeblikk, hvilket hadde du valgt?",
  "Hvis du kunne mestret en form for kunst automatisk, hvilken ville det vært?",
  "Hva er det mest interesante prosjekt du har jobbet på?",
  "Hva brukte du / hadde brukt din første lønning på?,
  ];
